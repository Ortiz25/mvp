...
export function Login({ onAuth }: { onAuth: () => void }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6"
      style={{ background: 'var(--bg-app)', transition: 'background 0.3s ease' }}>
      ...
      <div className="relative w-full max-w-sm panel p-6 md:p-8"
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display font-extrabold text-2xl mb-1"
            style={{ color: 'var(--text-primary)' }}>Admin Portal</h1>
